...
import { getAccessToken, getProfileInfo, setAccessToken } from "../redux/actions/profileAction"
...
const Login = ({ setLoggedIn, loggedIn }) => {
  ...
  const registerAuthor = async () => {
    try {
      ...
      console.log("logging in author", loggingInAuthor)
      dispatch(getAccessToken(loggingInAuthor))
      ...
      <div className="w-50" style={{ float: "right" }}>
        ...
        >
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {!loading && errorOccurred && <Alert variant="danger">Error logging in, try again!</Alert>}
            {!loading && !errorOccurred && postSuccess && <Alert variant="success">Login successful!</Alert>}
